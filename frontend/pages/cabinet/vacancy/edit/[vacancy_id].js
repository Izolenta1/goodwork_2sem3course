                ...
                <main className="grow flex flex-col items-center">
                    ...
                    <div className="w-[1140px] h-fit flex flex-col gap-[32px]">
                        ...
                        <div className='flex flex-col mt-[16px] gap-[8px]'>
                            <span className='text-[40px] leading-[40px] font-mulish font-[900] text-[#313131]'>Редактирование вакансии</span>
                        ...
                        <button onClick={() => sendVacancyForm()} className="w-[195px] h-[45px] bg-[#FF6F0E] rounded-[6px] flex justify-center items-center text-[18px] leading-[18px] font-[700] font-mulish text-[#FFFFFF]">Обновить</button>
                    </div>
                </main>
            </MainContainer>
        </>
